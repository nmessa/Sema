...
# Word Guess game
#Author: nmessa
#Ported to Python 3.2 from Python 2.7
...
def loadWords():
    ...
    # inFile: file
    #inFile = open(WORDLIST_FILENAME, 'r', 0) #Python 2
    inFile = open(WORDLIST_FILENAME, 'r') #Python 3
    # line: string
    line = inFile.readline()
    # wordlist: list of strings
    #print(line)
    #wordlist = string.split(line) #Python 2
    wordlist = line.split() #Python 3
...
def wordGuess(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while guessesLeft > 0 and not wordGuessed:
        ...
        #guess = raw_input("Please guess a letter: ")   #Python 2
        guess = input("Please guess a letter: ")        #Python 3
